...
class ListaFavoritos extends StatefulWidget {
  @override
  _ListaFavoritos  createState() => _ListaFavoritos ();
}

class _ListaFavoritos  extends State<ListaFavoritos >{
                          ...
                          Positioned(
                            ...
                            child: SizedBox(
                                ...
                                child: CheckboxListTile(
                                  //title: Text("Adicionar aos favoritos", style: TextStyle(color: Color(0xffb43144), fontSize: 14)),
                                  value: checkedValue,
                                  onChanged: (newValue) {
                                    setState(() {
