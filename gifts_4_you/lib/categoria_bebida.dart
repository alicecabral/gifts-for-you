...
class CategoriaBebida extends StatefulWidget {
  @override
  _CategoriaBebida createState() => _CategoriaBebida();
}

class _CategoriaBebida extends State<CategoriaBebida>{

  Future<List<dynamic>> lista_produtos() async {
    db_helper db = new db_helper();
    List<dynamic> produtos = await db.selectAll("produto",'Bebidas');
    if (produtos[0]) {
      ...
      appBar: AppBar(
        ...
        // ),
          flexibleSpace:GestureDetector(
            ...
            child: Image.asset(
              'assets/images/categoria_bebidas.png',
