...
class CategoriaCozinha extends StatefulWidget {
  @override
  _CategoriaCozinha createState() => _CategoriaCozinha();
}

class _CategoriaCozinha extends State<CategoriaCozinha>{

  Future<List<dynamic>> lista_produtos() async {
    db_helper db = new db_helper();
    List<dynamic> produtos = await db.selectAll("produto",'Cozinha');
    if (produtos[0]) {
      ...
      appBar: AppBar(
        ...
        // ),
          flexibleSpace:GestureDetector(
            ...
            child: Image.asset(
              'assets/images/categoria_cozinha.png',
